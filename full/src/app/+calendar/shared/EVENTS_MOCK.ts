...
export default [{
    ...
    "title": "Check Stock Details",
    "start": moment().add(7, 'day').startOf('day').add(22, 'hours'),
    "end": moment().add(8, 'day').startOf('day').add(22, 'hours'),
    "className": ["event", "bg-color-darken"]
},{
        "id": "544c4183be624ef013bb00a2",
        "title": "New Product Launch",
        "start": moment().add(22, 'day').startOf('day').add(23, 'hours'),
        "end": moment().add(22, 'day').startOf('day').add(23, 'hours'),
        "className": ["event", "bg-color-darken"]
},{
        "id": "544c4183be624ef013bb00a3",
        "title": "Account's Check",
        "start": moment().add(12, 'day').startOf('day').add(10, 'hours'),
        "end": moment().add(12, 'day').startOf('day').add(23, 'hours'),
        "className": ["event", "bg-color-darken"]
}];
